...
export function ForecastCard( { forecastData }: ForecastProps ) {
  return (
    <div
      className={`relative flex flex-col h-96 w-72 bg-gradient-to-b rounded-xl shadow-lg backdrop-blur-md border p-4 *:z-10 first:z-0 ${ forecastData.is_day ? 'from-blue-400 to-gray-100 *:text-gray-600 border-blue-300' : 'from-blue-900 to-gray-400 *:text-white border-gray-400' }`}>
      <img
